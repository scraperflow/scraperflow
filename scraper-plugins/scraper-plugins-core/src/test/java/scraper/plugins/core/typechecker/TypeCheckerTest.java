...
public class TypeCheckerTest {
    ...
    public <X> void simpleKeyLookupTypeVar() {
        ...
        t.setTerm(parseTemplate("{A}", t));
        check.typeTemplate(env, t);
        Assert.assertNotNull( check.captures.get("X") );
    }
    ...
    public <X> void nestedBindingOfTypeVariables() throws ValidationException {
        ...
        Assert.assertTrue(check.captures.containsKey("X"));
        Assert.assertTrue(check.captures.containsKey("X$ListOf"));

        Assert.assertEquals( "java.util.List<java.lang.Object>", check.captures.get("X").getTypeString() );
        Assert.assertEquals( "java.lang.Object", check.captures.get("X$ListOf").getTypeString() );
    }
    ...
    public <X> void nestedBindingOfTypeVariables2() throws ValidationException {
        ...
        Assert.assertTrue(check.captures.containsKey("X"));
        Assert.assertTrue(check.captures.containsKey("X$ListOf"));
        Assert.assertTrue(check.captures.containsKey("X$ListOfListOf"));

        Assert.assertEquals( "java.util.List<java.util.List<java.lang.Object>>", check.captures.get("X").getTypeString() );
        Assert.assertEquals( "java.util.List<java.lang.Object>", check.captures.get("X$ListOf").getTypeString() );
        Assert.assertEquals( "java.lang.Object", check.captures.get("X$ListOfListOf").getTypeString() );
    }
    ...
    public <X> void nestedBindingOfTypeVariables3() throws ValidationException {
        ...
        Assert.assertEquals( "java.util.List<java.util.List<java.lang.String>>", check.resolve("X").getTypeString() );
        Assert.assertEquals( "java.util.List<java.lang.String>", check.captures.get("X$ListOf").getTypeString() );
        Assert.assertEquals( "java.lang.String", check.captures.get("X$ListOfListOf").getTypeString() );
    }
    ...
    @Test(expected = TemplateException.class)
    public void isThisPossibleOrWhat2() throws ValidationException {
        { // obj :: Object
            T<Object> t = new T<>(){};
            t.setTerm(parseTemplate("{missing}" , t));
            check.typeTemplate(env, t);
        }
    }
