...
public abstract class TestNode extends AbstractNode {
    public TestNode() {
        ...
        this.jobPojo = new ScrapeInstance() {
            ...
            @Override public Map<InstanceAddress, ScrapeInstance> getImportedInstances() { return null; }
            @Override public void init() throws ValidationException { }
            @NotNull @Override public ExecutorsService getExecutors() { return null; }
            @NotNull @Override public HttpService getHttpService() { return null; }
            @NotNull @Override public ProxyReservation getProxyReservation() { return null; }
            @NotNull @Override public FileService getFileService() { return null; }
        };
    }
}
