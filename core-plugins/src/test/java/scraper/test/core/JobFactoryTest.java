...
public class JobFactoryTest {
    ...
    public void argsAsObjectTest() throws Exception {
        URL base = ClassLoader.getSystemResource("scraper/test/core/jobfactory/complexargs");
    ...
    public void convertScrapeJobTest() throws Exception {
        URL base = ClassLoader.getSystemResource("scraper/test/core/jobfactory/convert");
    ...
    public void resolvingAddressesTest() throws Exception {
        URL base = ClassLoader.getSystemResource("scraper/test/core/naming");
