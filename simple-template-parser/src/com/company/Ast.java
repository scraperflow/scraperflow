...
public class Ast {
    ...
    public static class MapKeyKeyNode extends TemplateNode {
        final TemplateNode key; public MapKeyKeyNode(TemplateNode key) { this.key = key; }
    }
    public static class ListIndexIndexNode extends TemplateNode {
        final TemplateNode index; public ListIndexIndexNode(TemplateNode index) { this.index = index; }
    }

    public static class MixedMapKeyNode extends TemplateNode {
        final TemplateNode map, more; public MixedMapKeyNode(TemplateNode map, TemplateNode more) { this.map = map; this.more = more; }
    }

    public static class MixedListIndexNode extends TemplateNode {
        final TemplateNode list, more; public MixedListIndexNode(TemplateNode list, TemplateNode more) { this.list = list; this.more = more; }
    }
}
